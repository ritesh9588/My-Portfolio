    ...
    <section id="experience" className="py-16 bg-white dark:bg-gray-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <div className="mt-2 h-1 w-20 bg-portfolio-blue dark:bg-blue mx-auto"></div>
        </div>

        <div className="max-w-3xl mx-auto">
          <div className="relative border-l-2 border-portfolio-blue  dark:portfolio-blue  ml-3">
            {experiences.map((exp, index) => (
              <div key={index} className="mb-10 ml-6">
                <div className="absolute w-6 h-6 bg-portfolio-blue  dark:bg-portfolio-blue  rounded-full -left-3 border-2 border-white dark:border-gray-900 flex items-center justify-center">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-portfolio-blue  dark:text-portfolio-blue ">
                  {exp.duration}
                </time>
